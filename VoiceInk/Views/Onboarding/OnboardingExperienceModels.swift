...
enum OnboardingExperienceCatalog {
    static let steps: [OnboardingExperienceStep] = [
        ...
        OnboardingExperienceStep(
            ...
            subtitle: "Turn your spoken note into a clean email draft with Quill.",
            sampleLabel: "Sample text",
        ...
        OnboardingExperienceStep(
            ...
            title: "Try Rewrite",
            subtitle: "Select the text on the screen, tell Quill the changes you want, and Quill will rewrite the text for you.",
            sampleLabel: "Sample text",
        ...
        OnboardingExperienceStep(
            ...
            subtitle: "Ask quick questions and Quill will serve you the answers.",
