...
struct OnboardingTrustScreen: View {
    ...
    var body: some View {
        OnboardingStepScreen(
            ...
            subtitle: "Review how Quill handles your data before choosing a license.",
...
private struct TrustHeader: View {
    var body: some View {
        VStack(spacing: 16) {
            ...
            Text("Quill is private by default")
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            VStack(spacing: 10) {
                ...
                Text("Quill is also open source, so you can inspect every single line of code.")
                    .font(.system(size: 13))
